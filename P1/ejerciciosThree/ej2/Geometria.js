...
class Geometria extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    this.add (this.created20());
    this.add (this.created12());
  ...
  created20(){
    ...
    var d20Geom = new THREE.IcosahedronGeometry(1);
  ...
  created12(){
    var d12Geom = new THREE.DodecahedronGeometry(1);

    var d12Mat = new THREE.MeshNormalMaterial();

    var d12 = new THREE.Mesh(d12Geom,d12Mat);
