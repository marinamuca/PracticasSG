...
class revolucion extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    var points = [];
    //Añado puntos al array
    points.push(new THREE.Vector3(0.001,0,0));
    points.push(new THREE.Vector3(1,0,0));
    points.push(new THREE.Vector3(1,1,0));
    points.push(new THREE.Vector3(0.001,1,0));

    var latheObject = new THREE.Mesh( new THREE.LatheGeometry(points), new THREE.MeshNormalMaterial());
  ...
  update () {
    ...
    // this.revolucion.rotation.x +=0.1;
