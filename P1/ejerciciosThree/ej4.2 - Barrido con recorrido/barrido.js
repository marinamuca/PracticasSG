...
class barrido extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    this.heartShape = this.createCorazon();
    ...
    this.extrudeSettings = { steps: 10, depth: 1, bevelEnabled: false, curveSegments: 5, extrudePath: path };
    
    var geometry = new THREE.ExtrudeGeometry(this.heartShape, this.extrudeSettings);
  ...
  createCorazon(){
    ...
    heartShape.quadraticCurveTo(1.5, 0.2, 0.8, 0.8)
    heartShape.quadraticCurveTo(0.2, 1, 0, 0.5);
    heartShape.quadraticCurveTo(-0.2, 1, -0.8, 0.8);
    heartShape.quadraticCurveTo(-1.5, 0.2, 0, -1);
    return heartShape;
  }
  ...
  createGUI (gui,titleGui) {
    ...
    folder.add (this.guiControls, 'steps', 1, 100, 1).name('Steps: ').listen();
